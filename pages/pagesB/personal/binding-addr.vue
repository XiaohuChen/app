<template>
	<view class="content">
		<view class="input-wrap padding-top">
			<view class="">
				<input class="input-left" placeholder="请输入地址" placeholder-class="input-placeholder" v-model="phone" @input="change">
			</view>
			<view>

				<input class="input-left" placeholder="请输入验证码" placeholder-class="input-placeholder" v-model="code">
